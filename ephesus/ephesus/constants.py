...
@unique
class BookNames(Enum, metaclass=MyEnumMeta):
    """
    All Bible book names.
    Includes stuff outside of the protestant Bible.
    Taken from https://docs.usfm.bible/usfm-usx-docs/latest/para/identification/books.html
    """
    ...
    BOOK_1KI = "1 Kings"
    BOOK_2KI = "2 Kings"
    BOOK_1CH = "1 Chronicles"
    BOOK_2CH = "2 Chronicles"
    BOOK_EZR = "Ezra"
    BOOK_NEH = "Nehemiah"
    BOOK_EST = "Esther"
    BOOK_JOB = "Job"
    BOOK_PSA = "Psalms"
    BOOK_PRO = "Proverbs"
    BOOK_ECC = "Ecclesiastes"
    BOOK_SNG = "Song of Songs"
    BOOK_ISA = "Isaiah"
    BOOK_JER = "Jeremiah"
    BOOK_LAM = "Lamentations"
    BOOK_EZK = "Ezekiel"
    BOOK_DAN = "Daniel"
    BOOK_HOS = "Hosea"
    BOOK_JOL = "Joel"
    ...
    BOOK_ACT = "Acts"
    BOOK_ROM = "Romans"
    BOOK_1CO = "1 Corinthians"
    BOOK_2CO = "2 Corinthians"
    BOOK_GAL = "Galatians"
    BOOK_EPH = "Ephesians"
    BOOK_PHP = "Philippians"
    BOOK_COL = "Colossians"
    BOOK_1TH = "1 Thessalonians"
    BOOK_2TH = "2 Thessalonians"
    BOOK_1TI = "1 Timothy"
    BOOK_2TI = "2 Timothy"
    BOOK_TIT = "Titus"
    BOOK_PHM = "Philemon"
    ...
    BOOK_TOB = "Tobit"
    BOOK_JDT = "Judith"
    BOOK_ESG = "Esther Greek"
    BOOK_WIS = "Wisdom of Solomon"
    BOOK_SIR = "Sirach"
    BOOK_BAR = "Baruch"
    BOOK_LJE = "Letter of Jeremiah"
    BOOK_S3Y = "Song of the 3 Young Men"
    BOOK_SUS = "Susanna"
    BOOK_BEL = "Bel and the Dragon"
    BOOK_1MA = "1 Maccabees"
    BOOK_2MA = "2 Maccabees"
    BOOK_3MA = "3 Maccabees"
    BOOK_4MA = "4 Maccabees"
    BOOK_1ES = "1 Esdras (Greek)"
    BOOK_2ES = "2 Esdras (Latin)"
    BOOK_MAN = "Prayer of Manasseh"
    BOOK_PS2 = "Psalm 151"
    BOOK_ODA = "Odae/Odes"
    BOOK_PSS = "Psalms of Solomon"
    BOOK_EZA = "Ezra Apocalypse"
    BOOK_5EZ = "5 Ezra"
    BOOK_6EZ = "6 Ezra"
    BOOK_DAG = "Daniel Greek"
    BOOK_PS3 = "Psalms 152-155"
    BOOK_2BA = "2 Baruch (Apocalypse)"
    BOOK_LBA = "Letter of Baruch"
    BOOK_JUB = "Jubilees"
    BOOK_ENO = "Enoch"
    BOOK_1MQ = "1 Meqabyan/Mekabis"
    BOOK_2MQ = "2 Meqabyan/Mekabis"
    BOOK_3MQ = "3 Meqabyan/Mekabis"
    BOOK_REP = "Reproof"
    BOOK_4BA = "4 Baruch"
    BOOK_LAO = "Letter to the Laodiceans"
